    ...
    <v-layout row wrap>
            <v-dialog v-model="dialog" max-width = "500" persistent>
              ...
              <v-card  >
                ...
                <v-card-actions>
                  <v-btn color="blue darken-1" flat @click="dialog = false" :disabled= progress>Cancel</v-btn>
                  <v-btn color="blue darken-1" flat :loading = progress @click="onBuyClicked(currIdx)">Buy</v-btn>
